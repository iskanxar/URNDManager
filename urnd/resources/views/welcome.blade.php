        ...
        <div class="relative flex items-top justify-center min-h-screen bg-white dark:bg-white sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center  sm:pt-0">
                        <img src="{{ asset('/images/logo-partner-urnd.jpg') }}" alt="" style="width:512px;">
                    ...
                    <div class="grid grid-cols-1 ">
                        <div class="p-6">
                            <div class="flex justify-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://urnd.uniten.edu.my/about-us/corporate-background/" class="underline text-gray-900 dark:text-white justify-center">UNITEN Research & Development  (URND) Manager </a></div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            <a href="https://urnd.uniten.edu.my/" class="ml-1 underline">
